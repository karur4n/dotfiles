...
2. `<vault>/wiki/schema.md` — 規約準拠判定の基準
3. `<vault>/wiki/index.md`, `<vault>/wiki/log.md`
4. `<vault>/wiki/<category>/*.md` — 必要に応じて全読み
...
### 規約違反
- wiki/<path>.md — <違反内容> — 修正案: <提案>

### 矛盾
- wiki/<A>.md vs wiki/<B>.md — <矛盾点> — 修正案: <提案>
